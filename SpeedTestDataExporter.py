...
file_input = open("EncryptedSpeedTestOutputs.txt", "r")

open("EncryptedSpeedTestDownUpData.csv", "w").close()  # Clear existing data.
file_output = open("EncryptedSpeedTestDownUpData.csv", "a")
